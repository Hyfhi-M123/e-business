  ...
  return (
    <main className="p-8 lg:p-10 max-w-[1600px] mx-auto w-full min-h-screen">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-10">
        ...
        <div className="flex gap-3 w-full md:w-auto">
          ...
          <Link 
            ...
            className="flex-1 md:flex-none flex items-center justify-center gap-2 bg-[#F77F00] text-white shadow-lg shadow-orange-500/20 rounded-2xl px-6 py-3 text-sm font-bold hover:bg-orange-600 transition-colors"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
        ...
        <motion.div initial={{opacity: 0, y: 20}} animate={{opacity: 1, y: 0}} transition={{delay: 0.1}} className="bg-white dark:bg-[#111] rounded-[2rem] p-6 border border-emerald-500/20 shadow-[0_4px_24px_rgba(16,185,129,0.05)] flex items-center gap-6">
          ...
          <div>
            <p className="text-xs font-bold text-emerald-600 dark:text-emerald-400 uppercase tracking-widest mb-1 flex items-center gap-2">
              Active Customers
            </p>
            <h3 className="text-3xl font-black text-[#212529] dark:text-white">{activeCustomers}</h3>
          </div>
        </motion.div>
                  ...
                  >
                    ...
                    <td className="py-4 px-8">
                      <div className="flex items-center gap-4">
                        <div className={`w-10 h-10 rounded-full flex items-center justify-center text-xs font-black shrink-0 bg-neutral-200 dark:bg-[#222] text-neutral-600 dark:text-neutral-300`}>
