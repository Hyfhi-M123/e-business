...
export default function Home() {
  ...
  return (
    <main className="bg-[#F8F9FA] dark:bg-neutral-950 text-[#212529] dark:text-white font-sans selection:bg-[#F77F00] dark:bg-orange-500 selection:text-[#212529] dark:text-white">
      ...
      {/* NAVBAR */}
      <nav className="fixed top-0 w-full z-[100] flex items-center justify-between px-6 py-6 md:px-12 backdrop-blur-sm bg-[#F8F9FA] dark:bg-neutral-950/20 border-b border-[#DEE2E6] dark:border-white/10">
      ...
      <div ref={containerRef} className="relative w-full h-[400vh]">
        ...
        <div className="sticky top-0 w-full h-screen overflow-hidden z-0 bg-[#F8F9FA] dark:bg-neutral-950">
        ...
        <div className="absolute top-0 left-0 w-full h-full z-10 pointer-events-none">
          ...
          >
            <div className="flex flex-col items-center">
              <div className="px-5 py-2 mb-8 border border-[#DEE2E6] dark:border-white/10 backdrop-blur-md bg-[#F8F9FA] dark:bg-neutral-950/40 shadow-2xl flex items-center gap-3 text-[10px] font-black tracking-[0.2em] uppercase">
                <span className="w-2 h-2 bg-red-500 rounded-full animate-ping"></span> Live Expedition Series
              </div>
              <h1 className="text-6xl md:text-9xl lg:text-[11rem] font-black uppercase tracking-tighter leading-[0.8] mix-blend-screen text-[#212529] dark:text-white/90 drop-shadow-[0_0_50px_rgba(255,255,255,0.2)]">
                ASCEND<br/>TO APEX.
              </h1>
              <p className="mt-8 text-[#495057] dark:text-neutral-300 md:text-xl font-bold uppercase tracking-[0.4em] max-w-lg mx-auto drop-shadow-md">
            ...
            >
              ...
              <span className="text-[9px] font-black uppercase tracking-[0.3em] text-[#F77F00] dark:text-orange-500">Engage Scroll</span>
            </motion.div>
          </motion.div>
          ...
          >
            <div className="max-w-xl">
               <ThermometerSnowflake className="w-12 h-12 text-[#40916C] dark:text-blue-400 mb-6 drop-shadow-[0_0_20px_rgba(96,165,250,0.8)]" />
               ...
               <p className="text-lg md:text-xl font-medium text-[#495057] dark:text-neutral-300 leading-relaxed max-w-md border-l-2 border-[#40916C] dark:border-blue-400/50 pl-6">
            ...
            <motion.div style={{ x: card1X }} className="hidden lg:flex flex-col gap-4 max-w-xs pointer-events-auto">
              <div className="bg-white dark:bg-neutral-900/60 backdrop-blur-xl border border-[#DEE2E6] dark:border-white/10 p-6 rounded-2xl shadow-2xl">
                <h4 className="text-[10px] font-black text-[#40916C] dark:text-blue-400 uppercase tracking-widest mb-4 flex justify-between">
                  <span>Modul Insulasi</span> <span>Active</span>
                </h4>
                <div className="h-1 w-full bg-[#E9ECEF] dark:bg-neutral-800 rounded-full overflow-hidden mb-2">
                   <div className="h-full bg-[#40916C] dark:bg-blue-400 w-[85%]" />
                </div>
                <p className="text-xs text-[#6C757D] dark:text-neutral-400 font-mono">Heat Retention: 85% Volumetric.</p>
              </div>
              <div className="bg-[#F77F00] dark:bg-[#F77F00]/10 dark:bg-orange-500/10 backdrop-blur-xl border border-orange-500/20 p-6 rounded-2xl shadow-2xl cursor-pointer hover:bg-[#F77F00] dark:bg-orange-500/20 transition-colors">
                <h4 className="text-sm font-black text-[#F77F00] dark:text-orange-500 uppercase tracking-widest mb-1">Eksplor Seri Termal</h4>
          ...
          >
            <div className="max-w-xl flex flex-col items-end text-right">
               <Wind className="w-12 h-12 text-[#F77F00] dark:text-orange-500 mb-6 drop-shadow-[0_0_20px_rgba(249,115,22,0.8)]" />
               <h2 className="text-4xl md:text-7xl font-black uppercase tracking-tighter leading-[0.9] mb-6">
                 Tanpa<br/><span className="text-transparent bg-clip-text bg-gradient-to-l from-orange-400 to-red-600">Ampun.</span>
               </h2>
               <p className="text-lg md:text-xl font-medium text-[#495057] dark:text-neutral-300 leading-relaxed max-w-md border-r-2 border-orange-500/50 pr-6">
            ...
            <motion.div style={{ x: card2X }} className="hidden lg:flex flex-col gap-4 max-w-sm pointer-events-auto">
               <div className="bg-white dark:bg-neutral-900/60 backdrop-blur-xl border border-[#DEE2E6] dark:border-white/10 p-6 rounded-2xl shadow-2xl overflow-hidden relative group cursor-pointer">
                  <div className="absolute inset-0 bg-[#F8F9FA] dark:bg-neutral-950 z-0 opacity-50 group-hover:opacity-20 transition-opacity" />
                  ...
                  <div className="relative z-10">
                    <h4 className="text-[10px] font-black text-[#212529] dark:text-white uppercase tracking-widest mb-8">Kajian Material</h4>
                    <span className="text-2xl font-black uppercase tracking-tight">Katalog Z-Shell</span>
                    <p className="text-xs text-[#6C757D] dark:text-neutral-400 mt-2 flex items-center gap-2">Baca Riset Selengkapnya <ArrowUpRight className="w-3 h-3"/></p>
                  </div>
               </div>
            </motion.div>
          </motion.div>
          ...
          <div className="absolute top-[300vh] w-full h-screen flex flex-col justify-end pb-20 px-6 md:px-12 pointer-events-auto bg-gradient-to-t from-neutral-950 via-neutral-950/80 to-transparent">
             ...
             <div className="flex justify-between items-end mb-10 pb-4 border-b border-[#DEE2E6] dark:border-white/10">
                ...
                <Link href="/katalog" className="hidden md:flex text-[10px] font-black uppercase tracking-[0.2em] text-[#212529] dark:text-white hover:text-[#F77F00] dark:text-orange-500 transition-colors items-center gap-2 border border-white/20 px-6 py-3 rounded-full hover:border-orange-500">
             ...
             <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {/* Card 1 */}
                <div onClick={() => window.location.href='/produk/123'} className="group relative h-72 rounded-3xl overflow-hidden cursor-pointer bg-white dark:bg-neutral-900 border border-[#1B4332]/10 dark:border-white/5">
                  ...
                  <div className="absolute bottom-6 left-6 z-20 w-[80%]">
                    ...
                    <p className="text-[10px] text-[#6C757D] dark:text-neutral-400 font-mono tracking-widest uppercase flex items-center gap-2">Initiate <ArrowUpRight className="w-3 h-3 text-[#F77F00] dark:text-orange-500" /></p>
                  </div>
                </div>

                {/* Card 2 */}
                <div onClick={() => window.location.href='/produk/124'} className="group relative h-72 rounded-3xl overflow-hidden cursor-pointer bg-white dark:bg-neutral-900 border border-[#1B4332]/10 dark:border-white/5">
                  <div className="absolute inset-0 bg-gradient-to-t from-neutral-950/90 via-neutral-950/20 to-transparent z-10" />
                  ...
                  <div className="absolute bottom-6 left-6 z-20 w-[80%]">
                    ...
                    <div className="w-0 h-px bg-white group-hover:w-full transition-all duration-500 mb-3" />
                    <p className="text-[10px] text-[#6C757D] dark:text-neutral-400 font-mono tracking-widest uppercase flex items-center gap-2">Initiate <ArrowUpRight className="w-3 h-3 text-[#40916C] dark:text-blue-400" /></p>
                  </div>
                </div>

                {/* Card 3 */}
                <div onClick={() => window.location.href='/produk/125'} className="group relative h-72 rounded-3xl overflow-hidden cursor-pointer bg-white dark:bg-neutral-900 border border-[#1B4332]/10 dark:border-white/5">
                  <div className="absolute inset-0 bg-gradient-to-t from-neutral-950/90 via-neutral-950/20 to-transparent z-10" />
                  ...
                  <div className="absolute bottom-6 left-6 z-20 w-[80%]">
                    ...
                    <div className="w-0 h-px bg-white group-hover:w-full transition-all duration-500 mb-3" />
                    <p className="text-[10px] text-[#6C757D] dark:text-neutral-400 font-mono tracking-widest uppercase flex items-center gap-2">Initiate <ArrowUpRight className="w-3 h-3 text-rose-500" /></p>
                  </div>
                </div>
             </div>
          </div>
