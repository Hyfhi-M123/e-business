...
export default function ThemeToggle() {
  ...
  if (!mounted) {
    return (
      <div className="fixed bottom-8 left-8 z-[100] w-12 h-12 rounded-full backdrop-blur-md border bg-white/80 dark:bg-neutral-900/80 border-[#DEE2E6] dark:border-white/10 shadow-lg" />
    );
  }
