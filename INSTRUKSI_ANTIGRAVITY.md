...
3.  **EKSEKUSI**: Selesaikan tugas dengan estetika **Earthy Premium** dan animasi **Morphing + Parallax** (Framer Motion).
...
## 🎨 Standar Estetika
- Palet Warna: Forest Green, Amber/Campfire, Deep Earth.
- Komponen: Glassmorphism (`backdrop-blur`) + Earth Tones.
- Animasi: Gunakan `layoutId` untuk morphing antar elemen + Parallax effect.
